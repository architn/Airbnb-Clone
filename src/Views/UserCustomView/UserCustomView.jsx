...
function UserCustomView() {
  ...
  return (
    <div className="container">
      ...
      {user && user.map((u) => <CreateNameElement key={u._id} {...u} />)}
      <br />
      <br />
      <div className="row">
        ...
        <br />
        {properties.length === 0 ? (
          <div className="nothingReserved">
            You have not listed any property yet!
          </div>
        ) : (
          properties.map((p) => (
            <CreatePropertiesJumbotron {...p} key={p._id} />
          ))
        )}
      </div>
      <br />
        ...
        {reservations.length === 0 ? (
          <div className="nothingReserved">
            <span className="msgText">
              You have not reserved any property yet
            </span>
          </div>
        ) : (
          reservations.map((r) => <CreateReservationCard {...r} key={r._id} />)
        )}
      </div>
      <br />
      <br />
